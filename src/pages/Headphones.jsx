...
//                     d="M5 15s-1 4 5 4 5-4 5-4V3s-2 2-5 2-5-2-5-2v12zM5 15s-1 4 5 4 5-4 5-4V3"
//                   />
//                 </svg>
//                 Add to Cart
//               </button>
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-8">
        {filteredHeadphonesData.map((product) => (
          <div
            className="relative flex flex-col overflow-hidden rounded-lg border border-#3596B5 bg-white shadow-md transform transition-transform hover:scale-105"
            key={product.id}
          >
            <Link
              to={`/ProductDes/${product.id}`}
